...
public class AddressBookPageTest extends TestBase {
	...
	public void validateUserCanAddNewAddress() {
		...
		addressBookPage = addAddressPage.SubmitAddress(Utility.generateRandomString(2),
				Utility.generateRandomString(2), Utility.generateRandomString(2), Utility.generateRandomString(8),
